...
export const NameBaige: React.FC<ProfileCardProps> = ({
  companyName,
  email,
}) => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column' }}>
        <BodyStrong color={COLORS.onSurfaceVariant}>{companyName}</BodyStrong>
        <BodySmall color='text.secondary'>{email}</BodySmall>
      </Box>
    </Box>
  );
};
